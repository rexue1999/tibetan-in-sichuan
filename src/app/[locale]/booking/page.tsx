            ...
            {contactMethods.map(({ key, href, external, icon, color, labelKey }) => (
              <div key={key} className="border border-stone-200 rounded-sm p-6 flex flex-col items-center text-center gap-3">
                ...
                <a
                  ...
                  className={`inline-flex items-center justify-center gap-2 px-6 py-2.5 text-xs font-medium tracking-[2px] uppercase rounded-sm transition-all mt-auto ${color}`}
                >
                  {tb(labelKey as any)}
                </a>
              </div>
