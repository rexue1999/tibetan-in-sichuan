...
import { contactChannels, CONTACT, type ContactChannel } from '../../../content/company';

/** Presentation for each contact channel. Link data comes from `contactChannels`. */
const channelStyle: Record<ContactChannel, { icon: JSX.Element; color: string }> = {
  whatsapp: {
    icon: (
    ...
    color: 'border border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white',
  },
  phone: {
    icon: (
    ...
    color: 'border border-[#8C3B2E] text-[#8C3B2E] hover:bg-[#8C3B2E] hover:text-white',
  },
  email: {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
